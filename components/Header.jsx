...
const categories = [ { name: "Web Development", slug: "webdev" }, { name: "Healthy Lifestyle", slug: "healthier" } ]

const Header = () => {
  return (
    <>
        <nav className='w-full h-[80px] md:h-[110px] flex items-center bg-[#050816] fixed'>
          <a 
        ...
        <div className='container mx-auto px-10 mb-8' >
            <div className='border-b w-full inline-block border-blue-400 py-8 mt-32' >
